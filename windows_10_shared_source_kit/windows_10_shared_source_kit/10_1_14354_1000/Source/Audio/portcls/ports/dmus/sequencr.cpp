...
NTSTATUS 
CSequencerMXF::SetState(__in KSSTATE State)    
{   
    PAGED_CODE();
...
NTSTATUS CSequencerMXF::ConnectOutput(__in PMXF sinkMXF)
{
    PAGED_CODE();
...
NTSTATUS CSequencerMXF::DisconnectOutput(__in PMXF sinkMXF)
{
    PAGED_CODE();
...
NTSTATUS CSequencerMXF::PutMessage(__in PDMUS_KERNEL_EVENT pDMKEvt)
{
