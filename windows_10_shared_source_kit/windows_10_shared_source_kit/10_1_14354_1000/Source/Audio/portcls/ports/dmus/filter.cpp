...
DEFINE_KSPROPERTY_TABLE(PropertyTable_Pin) 
{
    ...
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_NAME, PropertyHandler_Pin, 
        sizeof(KSP_PIN), 0, NULL, NULL, 0, NULL, PropertyHandler_Pin, 0)
};
...
)
{
    ...
    m_propertyContext.pulPinInstanceCounts = 
        new(NonPagedPoolNx,'cIcP') ULONG[m_Port->m_pSubdeviceDescriptor->PinCount];
...
)
{
    ...
    case IOCTL_KS_PROPERTY:
        ntStatus =
            ...
            (
                Irp,
                m_Port->m_pSubdeviceDescriptor->FilterPropertyTable,
