...
#pragma code_seg("PAGE")
NTSTATUS
CUnpackerMXF::SetState(__in KSSTATE State)
{
    PAGED_CODE();
...
//
NTSTATUS CUnpackerMXF::ConnectOutput(__in PMXF sinkMXF)
{
    PAGED_CODE();
...
//
NTSTATUS CUnpackerMXF::DisconnectOutput(__in PMXF sinkMXF)
{
    PAGED_CODE();
...
//
NTSTATUS CUnpackerMXF::PutMessage(__in PDMUS_KERNEL_EVENT)
{
...
NTSTATUS CUnpackerMXF::QueueShortEvent( PBYTE     pbData,
                                        __in_range(0, sizeof(PBYTE) - 1) USHORT    cbData,
