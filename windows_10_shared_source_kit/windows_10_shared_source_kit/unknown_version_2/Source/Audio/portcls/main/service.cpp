...
PcNewServiceGroup
(
    __out       PSERVICEGROUP * ppServiceGroup,
    __in_opt    PUNKNOWN        pUnknownOuter
)
{
    PAGED_CODE();
    ...
    :   CUnknown(pUnknownOuter)
{
    ...
    KeInitializeDpc(&m_kDpc,CServiceGroup::ServiceDpc,PVOID(this));
...
)
{
    ...
    PcWmiLogEvent( TRACE_LEVEL_VERBOSE,
                   PC_ETYPE_SC_DPC_CALLED,
                   PortCls_ServiceGroup_GUID,
                   NULL,
                   NULL,
                   0,
                   0,
...
)
{
    ...
    //
    PSERVICEGROUPMEMBER pServiceGroupMember = 
        new(NonPagedPoolNx,'mScP') SERVICEGROUPMEMBER;
